...
<div class="block">
	...
	<div class="inBlock">
		<p>Welcome to our The Music Outlet. If you continue to browse and
			use this website you are agreeing to comply with and be bound by the
			following terms and conditions of use, which together with our
			privacy policy govern The Music Outlet's relationship with you in
			relation to this website.The term "The Music Outlet" or "us" or "we"
			refers to the owner of the website whose registered office is 1234
			Sherbrooke Street West. The term "you" refers to the user or viewer
			of our website.</p>
		<br>
		...
		<ul class="bulletList">
			...
			<li>This website contains material which is owned by or licensed
			...
			<li>From time to time this website may also include links to
				...
				website(s).</li>
			<li>You may not create a link to this website from another
				website or document without The Music Outlet's prior written
				consent.</li>
			<li>Your use of this website and any dispute arising out of such
				use of the website is subject to the laws of Canada.</li>
		</ul>
		<br />
	</div>
</div>
