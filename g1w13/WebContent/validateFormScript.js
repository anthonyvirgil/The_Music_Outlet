...
function init() {
	...
	mandatoryFieldsArray[8] = document.getElementById("password2");
	...
	addEvent(mandatoryFieldsArray[6], "blur", validateEmail, false);
	addEvent(mandatoryFieldsArray[8], "blur", confirmPassword, false);
}
...
function confirmPassword() {
	var samePasswords;
	if (!(mandatoryFieldsArray[7].value === mandatoryFieldsArray[8].value)) {
		mandatoryFieldsArray[8].style.backgroundColor = "#f33";
		samePasswords = false;
	} else
		samePasswords = true;
